...
# Word側マクロ（RubiGUI_V30.bas）のマクロ名。
# ★重要：版が変わるたびに改名している
    ...
    def _macro_error_message(exc):
        ...
        if hresult in DISCONNECTED_HRESULTS:
            return (
                ...
                "繰り返し発生する場合は、RubiGUI_V30.bas が最新版か確認してください。\n"
